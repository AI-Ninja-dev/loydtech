      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mb-8 text-xl text-foreground/70 max-w-2xl mx-auto">
            Founded in 2020, Loydtech is a leading provider of IoT security solutions, dedicated to protecting the connected world through innovative technology and expert services.
          </p>
        </div>
      </div>
    </section>
