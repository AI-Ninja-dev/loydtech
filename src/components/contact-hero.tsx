      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mb-8 text-xl text-foreground/70 max-w-2xl mx-auto">
            Have questions about our IoT security solutions? Want to schedule a demo or learn more about our products?
            Our team is ready to help you secure your connected world.
          </p>
        </div>
      </div>
    </section>
