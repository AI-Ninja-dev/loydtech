      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mb-8 text-xl text-foreground/70 max-w-2xl mx-auto">
            Loydtech provides end-to-end security for the entire IoT lifecycle—from device manufacturing to deployment, network protection, cloud integration, and operational technology environments.
          </p>
        </div>
      </div>
    </section>
