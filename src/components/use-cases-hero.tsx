      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mb-8 text-xl text-foreground/70 max-w-2xl mx-auto">
            Loydtech secures IoT deployments across industries, from smart cities and healthcare to manufacturing and energy. Our solutions address the unique security challenges of each sector.
          </p>
        </div>
      </div>
    </section>
