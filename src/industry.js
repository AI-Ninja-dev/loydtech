...
const sectors = {
  healthcare: {
    ...
    lead: 'Locate medical equipment, connect remote patient monitoring workflows and support safer, more responsive assisted living.',
    challenge: 'Equipment moves between rooms, monitored conditions change, and care teams need timely context across sites and at home. Loydtech brings relevant locations, device readings and alerts into scoped operational views for the people responsible for responding.',
    scenarios: [
      ['Medical equipment tracking', 'Locate tagged pumps, wheelchairs and other mobile equipment on a custom digital floor map. Set room or department geofences, see the last known zone and review movement and availability.'],
      ['Remote patient monitoring', 'Connect suitable home or facility devices to bring agreed health readings, trends and threshold alerts into a care team workflow, with human review and clear escalation ownership.'],
      ['Smart assisted living', 'Use consent-based room or zone awareness, environmental sensors and configurable alerts to help support staff notice relevant changes and coordinate a response.'],
      ['Laboratory conditions', 'Monitor suitable refrigeration, incubator and room sensors, with condition history and alerts that support equipment and environmental oversight.'],
    ],
    rtls: 'Create a custom digital floor map of the facility, place tracked equipment in rooms or zones and set geofences for arrivals, departures or restricted areas. Use tags, anchors or gateways for location history; test coverage and accuracy on site.',
    sensing: 'Connect compatible equipment and environmental sensors, plus suitable remote patient monitoring devices where the clinical workflow and device integration have been agreed. Define readings, thresholds and alert recipients for each setting.',
    analytics: 'Explore equipment utilisation, repeated environmental excursions and agreed RPM trends for human review. Analytics support operational and care-team decisions; they do not replace clinical judgement.',
    integration: 'Scope connections to asset registers, maintenance systems, approved RPM records and notification channels with explicit permissions, consent and data boundaries.',
    platform: 'Sentinel 365 can show a custom hospital floor map with tagged equipment, geofence events, environmental trends and an alert timeline. Scoped web and mobile views can also show RPM readings and assisted-living alerts for authorised care teams.',
    services: ['Map priority wards, labs, home-care or assisted-living workflows', 'Pilot tags, gateways, sensors and compatible RPM devices', 'Build custom floor maps, geofences, dashboards and escalation rules', 'Integrate approved care and service workflows and train users'],
    security: 'Define device inventory, network separation, encryption, role-based access, consent and audit events with the healthcare organisation. Protect patient and resident data, and agree device suitability and clinical escalation responsibilities during project scoping.',
  },
  logistics: {
...
if (sector) {
  ...
  document.querySelector('#app').innerHTML = `
    ...
    <section class="sector-final"><div class="sector-shell"><p class="sector-kicker">PLAN A PILOT</p><h2>What needs to be visible at your site?</h2><p>Tell us about the assets, conditions and systems involved. We can scope a practical starting point.</p><a class="sector-button" href="mailto:info@loydtech.co.za?subject=${encodeURIComponent(`Loydtech ${sector.name} enquiry`)}">Email Loydtech ↗</a><a class="sector-text-link" href="https://docs.google.com/forms/d/e/1FAIpQLSeVMETqm4wW1EeeiBBJohh3q1OKe9G_gf4EwzhVmlXDdqIC7w/viewform?usp=header" target="_blank" rel="noopener noreferrer">Google enquiry form ↗</a><a class="sector-text-link" href="${root}#contact">See contact options →</a></div></section></main>
