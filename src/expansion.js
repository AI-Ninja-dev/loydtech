...
export function expandWebsite(solutions, asset) {
  ...
  const solutionLinks = `<a href="#technology">Four core capabilities</a><a href="#specifications">Specifications</a><a href="#solutions">Use cases</a>${solutions.map((s) => `<a href="#solutions" data-select="${s.id}">${s.title}</a>`).join("")}`;
  const industryLinks =
  ...
  document
    ...
    .insertAdjacentHTML(
      "beforeend",
      '<a href="#technology">Core technology</a><a href="#specifications">Specifications</a><a href="#apps">Web & mobile</a><a href="#agriculture">Agriculture IoT</a><a href="#healthcare">Healthcare IoT</a>',
    );
  document
