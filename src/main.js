...
<main id="main">
  ...
  <section class="section solutions-section" id="solutions"><div class="shell"><div class="section-heading reveal"><h2>Different challenges.<br><span class="spectrum">Connected answers.</span></h2><p>Explore use cases. RTLS, monitoring, analytics and integration can be combined for each sector.</p></div><div class="solution-tabs" role="tablist" aria-label="Solution areas">${solutions.map((s, i) => `<button role="tab" id="tab-${s.id}" data-tab="${s.id}" aria-selected="${i === 0}" aria-controls="solution-panel" tabindex="${i === 0 ? 0 : -1}">${s.title}</button>`).join("")}</div><div class="solution-panel" id="solution-panel" role="tabpanel" aria-labelledby="tab-tracking" tabindex="0"></div></div></section>
...
<footer class="shell"><div class="footer-top"><a class="brand" href="#top">${brand}</a><p>Connected intelligence.<br>A smarter tomorrow.</p><nav aria-label="Footer navigation"><a href="#platform">Sentinel 365</a><a href="#solutions">Solutions</a><a href="#security">Cybersecurity</a><a href="#pricing">Pricing</a><a href="#about">About Loydtech</a><a href="mailto:info@loydtech.co.za">Contact</a></nav></div><div class="footer-bottom"><span>© ${new Date().getFullYear()} Loydtech Digital Solutions.</span><span>South Africa</span><button class="plain-button" data-privacy>Privacy</button></div></footer>
