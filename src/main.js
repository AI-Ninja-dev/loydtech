...
<main id="main">
  ...
  <section class="section shell testimonials-section" id="testimonials" aria-labelledby="testimonials-title"><div class="testimonials-copy reveal"><p class="eyebrow">CLIENT VOICES</p><h2 id="testimonials-title">Real feedback.<br><span class="soft">In the client’s own words.</span></h2><p>We’re gathering permission to publish customer experiences here. We only display a testimonial once the customer approves the wording and attribution.</p></div><div class="testimonial-invite reveal"><span class="testimonial-mark" aria-hidden="true">“</span><h3>Worked with Loydtech?</h3><p>Tell us what changed for your team. We’ll ask before sharing your words publicly.</p><a class="button secondary" href="mailto:info@loydtech.co.za?subject=Loydtech%20customer%20feedback">Share your experience <span aria-hidden="true">↗</span></a></div></section>
...
<footer class="shell"><div class="footer-top"><a class="brand" href="#top">${brand}</a><p>Connected intelligence.<br>A smarter tomorrow.</p><nav aria-label="Footer navigation"><a href="#platform">Sentinel 365</a><a href="#industries">Sectors</a><a href="#security">Cybersecurity</a><a href="#pricing">Pricing</a><a href="#about">About Loydtech</a><a href="#roadmap">Roadmap</a><a href="#testimonials">Client voices</a><a href="mailto:info@loydtech.co.za">Contact</a></nav></div><div class="footer-bottom"><span>© ${new Date().getFullYear()} Loydtech Digital Solutions.</span><span>South Africa</span><button class="plain-button" data-privacy>Privacy</button></div></footer>
