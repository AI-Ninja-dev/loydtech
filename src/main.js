...
<main id="main">
  ...
  <section class="section shell testimonials-section" id="testimonials" aria-labelledby="testimonials-title"><div class="testimonials-copy reveal"><p class="eyebrow">ILLUSTRATIVE CUSTOMER PERSPECTIVES</p><h2 id="testimonials-title">What connected operations<br><span class="soft">could change.</span></h2><p>These fictional examples show possible use cases. They are not feedback from Loydtech customers or evidence of a deployment.</p></div><div class="testimonial-grid reveal"><article class="testimonial-card"><p class="testimonial-sector">01 / HEALTHCARE</p><blockquote>“Seeing a medical device’s last known zone on a hospital map would give our team a faster way to find it when it’s needed.”</blockquote><p class="testimonial-role">Illustrative scenario · Hospital equipment team</p></article><article class="testimonial-card"><p class="testimonial-sector">02 / AGRICULTURE</p><blockquote>“Tracking cattle across grazing areas and getting an alert when one leaves a geofenced zone would make daily checks easier.”</blockquote><p class="testimonial-role">Illustrative scenario · Farm manager</p></article><article class="testimonial-card"><p class="testimonial-sector">03 / CUSTOM MAPS</p><blockquote>“A map tailored to our own site would help us see assets and alerts in context, with geofences around the places that matter.”</blockquote><p class="testimonial-role">Illustrative scenario · Site operations lead</p></article><article class="testimonial-card"><p class="testimonial-sector">04 / RETAIL</p><blockquote>“Knowing where tagged equipment is across stores would make handovers and stock checks much simpler.”</blockquote><p class="testimonial-role">Illustrative scenario · Retail operations team</p></article><article class="testimonial-card"><p class="testimonial-sector">05 / COLD CHAIN</p><blockquote>“Temperature alerts linked to a shipment would help us investigate an excursion early and review its journey afterward.”</blockquote><p class="testimonial-role">Illustrative scenario · Cold chain coordinator</p></article></div></section>
...
<footer class="shell"><div class="footer-top"><a class="brand" href="#top">${brand}</a><p>Connected intelligence.<br>A smarter tomorrow.</p><nav aria-label="Footer navigation"><a href="#platform">Sentinel 365</a><a href="#industries">Sectors</a><a href="#security">Cybersecurity</a><a href="#pricing">Pricing</a><a href="#about">About Loydtech</a><a href="#roadmap">Roadmap</a><a href="#testimonials">Use case perspectives</a><a href="mailto:info@loydtech.co.za">Contact</a></nav></div><div class="footer-bottom"><span>© ${new Date().getFullYear()} Loydtech Digital Solutions.</span><span>South Africa</span><button class="plain-button" data-privacy>Privacy</button></div></footer>
