...
const partners = [
  { name: "Milesight", file: "milesight.svg", width: 164, height: 50 },
  { name: "Huawei", file: "huawei.png", width: 156, height: 50 },
  { name: "Cisco", file: "cisco.svg", width: 108, height: 57 },
  { name: "Minew", file: "minew.png", width: 148, height: 50 },
  { name: "MOKO SMART", file: "mokosmart.png", width: 76, height: 70 },
];
const partnerLogos = (duplicate = false) => partners.map(({ name, file, width, height }) =>
  `<span class="partner-logo${name === "MOKO SMART" ? " partner-logo--moko" : ""}${file ? "" : " partner-logo--text"}">${file ? `<img src="${asset(`partners/${file}`)}" alt="${duplicate ? "" : name}" width="${width}" height="${height}" decoding="async">` : `<span>${name}</span>`}</span>`
).join("");
...
<main id="main">
  ...
  <section class="section industry-section" id="industries"><div class="shell"><div class="section-heading centered reveal"><h2>Built around your environment.</h2><p>Explore connected sensing across six environments. Select an industry to see its use cases, technology and services.</p></div><div class="industry-grid reveal">${industries.map((x, i) => `<a id="${["healthcare", "logistics", "buildings", "pharmaceutical", "retail", "agriculture"][i]}" class="industry-card ${i === 0 ? "featured" : ""}" href="${import.meta.env.BASE_URL}industries/${["healthcare", "logistics", "buildings", "pharmaceutical", "retail", "agriculture"][i]}/"><img class="industry-card__image" src="${asset(x[3])}?v=2" sizes="(max-width: 760px) 100vw, 50vw" alt="${x[4]}" width="1536" height="1024" loading="lazy" decoding="async"><span class="industry-card__content"><small>${x[1]}</small><strong>${x[0]}</strong><span class="industry-description">${x[2]}</span></span><b aria-hidden="true">↗</b></a>`).join("")}</div></div></section>
  <section class="partners-section" aria-labelledby="partners-title"><div class="shell partners-heading"><p class="eyebrow">TECHNOLOGY ECOSYSTEM</p><h2 id="partners-title">Connected with established technology.</h2></div><div class="partner-marquee" tabindex="0" role="region" aria-label="Technology company logos"><div class="partner-track"><div class="partner-group">${partnerLogos()}</div><div class="partner-group" aria-hidden="true">${partnerLogos(true)}</div></div></div></section>
  ...
  <section class="section roadmap-section" id="roadmap" aria-labelledby="roadmap-title"><div class="shell roadmap-layout"><div class="roadmap-intro reveal"><p class="eyebrow">COMPANY ROADMAP</p><h2 id="roadmap-title">Build what works.<br><span class="soft">Then build on it.</span></h2><p>Our direction starts with practical IoT deployments and grows through a central platform, mobile access and secure analytics. Each step is guided by customer requirements and validated use cases.</p><a class="text-link" href="#contact">Talk about your roadmap <span aria-hidden="true">↗</span></a></div><ol class="roadmap-steps reveal"><li><span class="roadmap-index">01 / TODAY</span><div><h3>Focused connected solutions</h3><p>Scope RTLS, remote monitoring and integrations around a clear operational need, with cybersecurity defined from the start.</p></div></li><li><span class="roadmap-index">02 / BUILDING TOWARD</span><div><h3>Sentinel 365 views</h3><p>Bring validated location, sensor and alert workflows into a central web experience with role-appropriate mobile views.</p></div></li><li><span class="roadmap-index">03 / LONGER TERM</span><div><h3>Deeper operational intelligence</h3><p>Expand useful analytics and integrations across sites while strengthening governance, auditability and response workflows.</p></div></li></ol></div><p class="shell roadmap-note">This is a direction of travel, not a dated product-release commitment. Availability is confirmed for each project scope.</p></section>
  <section class="section shell testimonials-section" id="testimonials" aria-labelledby="testimonials-title"><div class="testimonials-copy reveal"><p class="eyebrow">CONNECTED USE CASES</p><h2 id="testimonials-title">One stack.<br><span class="soft">Different challenges.</span></h2><p>Across healthcare, agriculture, logistics, retail and buildings, combine the capabilities that fit your operation.</p></div><div class="testimonial-grid reveal"><article class="testimonial-card"><p class="testimonial-sector">HEALTHCARE / RTLS</p><h3>Find equipment faster.</h3><p>See the last known zone of tagged medical equipment on a hospital map, then direct teams to the right area.</p></article><article class="testimonial-card"><p class="testimonial-sector">AGRICULTURE / GEOFENCING</p><h3>Keep track of the herd.</h3><p>Follow tagged cattle across grazing areas and set mobile alerts for defined outdoor boundaries.</p></article><article class="testimonial-card"><p class="testimonial-sector">COLD CHAIN / MONITORING</p><h3>Watch every condition.</h3><p>Bring shipment temperature readings and threshold alerts into one view, with a history to investigate excursions.</p></article><article class="testimonial-card"><p class="testimonial-sector">RETAIL / INTEGRATION</p><h3>Connect store operations.</h3><p>Bring asset status, sensor events and existing workflows together so teams can act with shared context.</p></article><article class="testimonial-card"><p class="testimonial-sector">BUILDINGS / AI ANALYTICS</p><h3>Spot patterns in the data.</h3><p>Explore environmental and equipment trends across sites to flag unusual changes for human review.</p></article><article class="testimonial-card"><p class="testimonial-sector">MULTI-SITE / PLATFORM &amp; SECURITY</p><h3>See it. Share it. Secure it.</h3><p>Use site-specific maps and mobile views while defining access roles, device boundaries and audit trails.</p></article></div></section>
  <section class="section research-section" id="research" aria-labelledby="research-title"><div class="shell"><div class="section-heading reveal"><p class="eyebrow">RESEARCH &amp; INDUSTRY NEWS · REVIEWED SEPTEMBER 2026</p><h2 id="research-title">What is changing<br><span class="soft">in connected technology.</span></h2><p>Selected research and standards updates relevant to tracking, monitoring, analytics and secure IoT deployments.</p></div><div class="research-grid reveal"><article class="research-card"><p class="research-meta">RTLS · JULY 2026 · IEEE SIGNAL PROCESSING SOCIETY</p><h3>Indoor positioning works best when the environment shapes the choice.</h3><p>An IEEE overview compares Bluetooth, Wi-Fi and UWB positioning, and explores combining methods where one signal alone has limits.</p><a href="https://signalprocessingsociety.org/index.php/newsletter/2026/07/are-we-there-yet-indoor-localization-and-tracking" target="_blank" rel="noopener noreferrer">Read the IEEE overview <span aria-hidden="true">↗</span></a></article><article class="research-card"><p class="research-meta">ASSET TRACKING · JUNE 2026 · BLUETOOTH SIG</p><h3>Bluetooth adds more precise distance awareness.</h3><p>Channel Sounding uses measurements between supported devices to improve ranging, with hardware compatibility central to adoption.</p><a href="https://www.bluetooth.com/blog/true-distance-awareness-with-bluetooth-channel-sounding/" target="_blank" rel="noopener noreferrer">Read the Bluetooth SIG article <span aria-hidden="true">↗</span></a></article><article class="research-card"><p class="research-meta">SENSORS &amp; AI · 2026 · PENN STATE</p><h3>Live building data meets short-term forecasts.</h3><p>A 2026 conference paper describes a framework that combines sensor streams, dashboards and forecasting for smart building monitoring.</p><a href="https://pure.psu.edu/en/publications/an-iot-driven-machine-learning-framework-for-real-time-monitoring/" target="_blank" rel="noopener noreferrer">Read the research summary <span aria-hidden="true">↗</span></a></article><article class="research-card"><p class="research-meta">IOT SECURITY · APRIL 2026 · NIST</p><h3>Device security starts before installation.</h3><p>NIST’s updated guidance sets out foundational cybersecurity work for IoT product makers, useful when assessing device and platform choices.</p><a href="https://csrc.nist.gov/pubs/ir/8259/r1/final" target="_blank" rel="noopener noreferrer">Read the NIST guidance <span aria-hidden="true">↗</span></a></article></div></div></section>
