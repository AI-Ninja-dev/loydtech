...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en-ZA"><body className={geist.className}><a className="skip-link" href="#main">Skip to content</a><SiteMotion/><Header/><main id="main">{children}</main><Footer/></body></html>}
